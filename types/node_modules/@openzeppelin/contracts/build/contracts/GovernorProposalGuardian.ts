...
export interface GovernorProposalGuardianInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
  ...
  encodeFunctionData(
    functionFragment: "proposalGuardian",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setProposalGuardian",
    values: [AddressLike]
  ): string;
...
export namespace ProposalGuardianSetEvent {
  export type InputTuple = [
    oldProposalGuardian: AddressLike,
    newProposalGuardian: AddressLike
  ];
  export type OutputTuple = [
    oldProposalGuardian: string,
    newProposalGuardian: string
  ];
  export interface OutputObject {
    oldProposalGuardian: string;
    newProposalGuardian: string;
...
export interface GovernorProposalGuardian extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorProposalGuardian;
  waitForDeployment(): Promise<this>;

  interface: GovernorProposalGuardianInterface;
  ...
  proposalGuardian: TypedContractMethod<[], [string], "view">;
  ...
  setProposalGuardian: TypedContractMethod<
    [newProposalGuardian: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "proposalGuardian"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "setProposalGuardian"
  ): TypedContractMethod<
    [newProposalGuardian: AddressLike],
    [void],
    "nonpayable"
  ...
  >;
  getEvent(
    key: "ProposalGuardianSet"
  ): TypedContractEvent<
    ProposalGuardianSetEvent.InputTuple,
    ProposalGuardianSetEvent.OutputTuple,
    ProposalGuardianSetEvent.OutputObject
  >;
  getEvent(
    key: "ProposalQueued"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "ProposalGuardianSet(address,address)": TypedContractEvent<
      ProposalGuardianSetEvent.InputTuple,
      ProposalGuardianSetEvent.OutputTuple,
      ProposalGuardianSetEvent.OutputObject
    >;
    ProposalGuardianSet: TypedContractEvent<
      ProposalGuardianSetEvent.InputTuple,
      ProposalGuardianSetEvent.OutputTuple,
      ProposalGuardianSetEvent.OutputObject
    >;
