...
export interface GovernorSuperQuorumInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface GovernorSuperQuorum extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorSuperQuorum;
  waitForDeployment(): Promise<this>;

  interface: GovernorSuperQuorumInterface;
