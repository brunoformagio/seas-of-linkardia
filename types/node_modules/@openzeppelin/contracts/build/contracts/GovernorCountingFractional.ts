...
export interface GovernorCountingFractionalInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface GovernorCountingFractional extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorCountingFractional;
  waitForDeployment(): Promise<this>;

  interface: GovernorCountingFractionalInterface;
