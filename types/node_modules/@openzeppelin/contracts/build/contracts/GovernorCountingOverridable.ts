...
export interface GovernorCountingOverridableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
  ...
  encodeFunctionData(
    functionFragment: "OVERRIDE_BALLOT_TYPEHASH",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "castOverrideVote",
    values: [BigNumberish, BigNumberish, string]
  ): string;
  encodeFunctionData(
    functionFragment: "castOverrideVoteBySig",
    values: [BigNumberish, BigNumberish, AddressLike, string, BytesLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "hasVotedOverride",
    values: [BigNumberish, AddressLike]
  ): string;
  encodeFunctionData(
...
export namespace OverrideVoteCastEvent {
  export type InputTuple = [
    voter: AddressLike,
...
export namespace VoteReducedEvent {
  export type InputTuple = [
...
export interface GovernorCountingOverridable extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorCountingOverridable;
  waitForDeployment(): Promise<this>;

  interface: GovernorCountingOverridableInterface;
  ...
  OVERRIDE_BALLOT_TYPEHASH: TypedContractMethod<[], [string], "view">;
  ...
  castOverrideVote: TypedContractMethod<
    [proposalId: BigNumberish, support: BigNumberish, reason: string],
    [bigint],
    "nonpayable"
  >;

  castOverrideVoteBySig: TypedContractMethod<
    [
      proposalId: BigNumberish,
      support: BigNumberish,
      voter: AddressLike,
  ...
  hasVotedOverride: TypedContractMethod<
    [proposalId: BigNumberish, account: AddressLike],
    [boolean],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "OVERRIDE_BALLOT_TYPEHASH"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "castOverrideVote"
  ): TypedContractMethod<
    [proposalId: BigNumberish, support: BigNumberish, reason: string],
    [bigint],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "castOverrideVoteBySig"
  ): TypedContractMethod<
    [
      proposalId: BigNumberish,
      support: BigNumberish,
  ...
  >;
  getFunction(
    nameOrSignature: "hasVotedOverride"
  ): TypedContractMethod<
    [proposalId: BigNumberish, account: AddressLike],
    [boolean],
    "view"
  ...
  >;
  getEvent(
    key: "OverrideVoteCast"
  ): TypedContractEvent<
    OverrideVoteCastEvent.InputTuple,
    OverrideVoteCastEvent.OutputTuple,
    OverrideVoteCastEvent.OutputObject
  >;
  getEvent(
  ...
  getEvent(
    ...
    VoteReducedEvent.InputTuple,
    VoteReducedEvent.OutputTuple,
    VoteReducedEvent.OutputObject
  >;
  ...
  filters: {
    ...
    "OverrideVoteCast(address,uint256,uint8,uint256,string)": TypedContractEvent<
      OverrideVoteCastEvent.InputTuple,
      OverrideVoteCastEvent.OutputTuple,
      OverrideVoteCastEvent.OutputObject
    >;
    OverrideVoteCast: TypedContractEvent<
      OverrideVoteCastEvent.InputTuple,
      OverrideVoteCastEvent.OutputTuple,
      OverrideVoteCastEvent.OutputObject
    >;
    ...
    "VoteReduced(address,uint256,uint8,uint256)": TypedContractEvent<
      VoteReducedEvent.InputTuple,
      VoteReducedEvent.OutputTuple,
      VoteReducedEvent.OutputObject
    >;
    VoteReduced: TypedContractEvent<
      VoteReducedEvent.InputTuple,
      VoteReducedEvent.OutputTuple,
      VoteReducedEvent.OutputObject
    >;
