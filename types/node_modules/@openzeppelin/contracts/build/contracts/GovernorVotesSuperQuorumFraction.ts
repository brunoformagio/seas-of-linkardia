...
export interface GovernorVotesSuperQuorumFractionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export namespace SuperQuorumNumeratorUpdatedEvent {
  export type InputTuple = [
    oldSuperQuorumNumerator: BigNumberish,
    newSuperQuorumNumerator: BigNumberish
  ];
  export type OutputTuple = [
    oldSuperQuorumNumerator: bigint,
    newSuperQuorumNumerator: bigint
  ];
  export interface OutputObject {
    oldSuperQuorumNumerator: bigint;
    newSuperQuorumNumerator: bigint;
...
export interface GovernorVotesSuperQuorumFraction extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorVotesSuperQuorumFraction;
  waitForDeployment(): Promise<this>;

  interface: GovernorVotesSuperQuorumFractionInterface;
