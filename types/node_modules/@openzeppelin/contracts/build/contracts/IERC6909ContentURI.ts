...
export interface IERC6909ContentURIInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface IERC6909ContentURI extends BaseContract {
  connect(runner?: ContractRunner | null): IERC6909ContentURI;
  waitForDeployment(): Promise<this>;

  interface: IERC6909ContentURIInterface;
