...
export interface IERC6909TokenSupplyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface IERC6909TokenSupply extends BaseContract {
  connect(runner?: ContractRunner | null): IERC6909TokenSupply;
  waitForDeployment(): Promise<this>;

  interface: IERC6909TokenSupplyInterface;
