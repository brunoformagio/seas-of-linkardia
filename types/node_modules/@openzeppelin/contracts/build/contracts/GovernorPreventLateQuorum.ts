...
export interface GovernorPreventLateQuorumInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export namespace LateQuorumVoteExtensionSetEvent {
  export type InputTuple = [
...
export namespace ProposalExtendedEvent {
  export type InputTuple = [
    proposalId: BigNumberish,
    extendedDeadline: BigNumberish
  ];
  export type OutputTuple = [proposalId: bigint, extendedDeadline: bigint];
  export interface OutputObject {
    proposalId: bigint;
...
export interface GovernorPreventLateQuorum extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorPreventLateQuorum;
  ...
  >;
  getFunction(
    nameOrSignature: "lateQuorumVoteExtension"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  >;
  getEvent(
    key: "LateQuorumVoteExtensionSet"
  ): TypedContractEvent<
  ...
  >;
  getEvent(
    key: "ProposalExtended"
  ): TypedContractEvent<
    ProposalExtendedEvent.InputTuple,
    ProposalExtendedEvent.OutputTuple,
    ProposalExtendedEvent.OutputObject
  >;
  getEvent(
    key: "ProposalQueued"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "LateQuorumVoteExtensionSet(uint64,uint64)": TypedContractEvent<
      LateQuorumVoteExtensionSetEvent.InputTuple,
      LateQuorumVoteExtensionSetEvent.OutputTuple,
      LateQuorumVoteExtensionSetEvent.OutputObject
    >;
    LateQuorumVoteExtensionSet: TypedContractEvent<
      LateQuorumVoteExtensionSetEvent.InputTuple,
      LateQuorumVoteExtensionSetEvent.OutputTuple,
      LateQuorumVoteExtensionSetEvent.OutputObject
    >;
    ...
    "ProposalExtended(uint256,uint64)": TypedContractEvent<
      ProposalExtendedEvent.InputTuple,
      ProposalExtendedEvent.OutputTuple,
      ProposalExtendedEvent.OutputObject
    >;
    ProposalExtended: TypedContractEvent<
      ProposalExtendedEvent.InputTuple,
      ProposalExtendedEvent.OutputTuple,
      ProposalExtendedEvent.OutputObject
    >;
