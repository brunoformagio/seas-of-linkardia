...
export interface GovernorStorageInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface GovernorStorage extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorStorage;
  ...
  proposalDetails: TypedContractMethod<
    [proposalId: BigNumberish],
    [
  ...
  proposalDetailsAt: TypedContractMethod<
    [index: BigNumberish],
    [
  ...
  >;
  getFunction(
    nameOrSignature: "proposalDetailsAt"
  ): TypedContractMethod<
    [index: BigNumberish],
    [
      [bigint, string[], bigint[], string[], string] & {
