...
export interface GovernorSequentialProposalIdInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface GovernorSequentialProposalId extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorSequentialProposalId;
  waitForDeployment(): Promise<this>;

  interface: GovernorSequentialProposalIdInterface;
