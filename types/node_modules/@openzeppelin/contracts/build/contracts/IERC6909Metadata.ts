...
export interface IERC6909MetadataInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export namespace OperatorSetEvent {
  ...
  export type OutputTuple = [owner: string, spender: string, approved: boolean];
  export interface OutputObject {
    owner: string;
    spender: string;
    approved: boolean;
...
export interface IERC6909Metadata extends BaseContract {
  connect(runner?: ContractRunner | null): IERC6909Metadata;
  ...
  decimals: TypedContractMethod<[id: BigNumberish], [bigint], "view">;
  ...
  symbol: TypedContractMethod<[id: BigNumberish], [string], "view">;
