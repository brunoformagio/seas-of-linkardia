...
export interface ERC6909ContentURIInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface ERC6909ContentURI extends BaseContract {
  connect(runner?: ContractRunner | null): ERC6909ContentURI;
  waitForDeployment(): Promise<this>;

  interface: ERC6909ContentURIInterface;
