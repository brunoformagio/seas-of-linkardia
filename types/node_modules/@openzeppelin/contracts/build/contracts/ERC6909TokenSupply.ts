...
export interface ERC6909TokenSupplyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface ERC6909TokenSupply extends BaseContract {
  connect(runner?: ContractRunner | null): ERC6909TokenSupply;
  waitForDeployment(): Promise<this>;

  interface: ERC6909TokenSupplyInterface;
