...
import type {
  ERC6909Metadata,
  ERC6909MetadataInterface,
} from "../../../../../../node_modules/@openzeppelin/contracts/build/contracts/ERC6909Metadata";
...
type ERC6909MetadataConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: ERC6909MetadataConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class ERC6909Metadata__factory extends ContractFactory {
  constructor(...args: ERC6909MetadataConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): ERC6909Metadata__factory {
    return super.connect(runner) as ERC6909Metadata__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): ERC6909MetadataInterface {
    return new Interface(_abi) as ERC6909MetadataInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ERC6909Metadata {
    return new Contract(address, _abi, runner) as unknown as ERC6909Metadata;
  }
}
