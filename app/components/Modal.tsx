    ...
    open && (
      <div className={`fixed left-0 top-0 !p-4 ${removeOverlay ? "bg-transparent" : "bg-black/50 bg-opacity-50"} w-screen h-screen flex items-start md:items-center  justify-start md:justify-center z-[10] `}>
        <dialog
          ref={modalRef}
          aria-modal="true"
          className="p-3 bg-transparent md:mx-auto w-auto md:h-auto  md:mt-0 mt-[40px] max-w-full md:!max-w-[550px] space-y-3 flex flex-col  justify-between md:justify-center"
        >
